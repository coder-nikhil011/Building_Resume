...
export default function Footer() {
  return (
    <footer style={{ background: "#111827", color: "#fff", fontFamily: "Arial, sans-serif" }}>
      ...
      {/* ── Bottom bar: copyright + Start for free ── */}
      <div style={{ maxWidth: "1280px", margin: "0 auto", padding: "20px 32px", display: "flex", alignItems: "center", justifyContent: "space-between", flexWrap: "wrap", gap: "12px" }}>
        <div style={{ display: "flex", items: "center", gap: "16px", flexWrap: "wrap" }}>
